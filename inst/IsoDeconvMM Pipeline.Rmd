...
for(i in 1:length(BAM_list)){
  ...
  # counting
  # ----------------------------------------------------------
  ctF  = sprintf("%s/count_%s.txt", outputDir,sami)
  ...
  # sorting
  # ----------------------------------------------------------
  cmd2 = sprintf("samtools sort -n %s %s/%s_sorted_by_name", bam2use[i], outputDir, sami)
  system(cmd2)
  bamF = sprintf("%s/%s_sorted_by_name.bam", outputDir, sami)
  
  # ----------------------------------------------------------
  # getUnique and filtering
  # ----------------------------------------------------------
  prepareBAM(bamF, sprintf("%s/%s_sorted_by_name", outputDir, sami), sortIt=FALSE)
